...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prototype similarity inference with full diffusion sampling")
    ...
    parser.add_argument(
        "--output-subdir",
        default="full-diffusion-prototype",
        help="Subdir under prediction experiment folder (default: full-diffusion-prototype)",
    )
    parser.add_argument(
        "--sim",
        choices=["dot", "cosine"],
...
def main() -> None:
    ...
    for release in test_releases:
        ...
        print(f"saved full diffusion prototype predictions -> {out_csv}")
