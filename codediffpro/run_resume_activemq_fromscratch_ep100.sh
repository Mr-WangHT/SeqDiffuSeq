...
/mnt/sda/wanght19/anaconda3/envs/FVD-DPM/bin/python codediffpro/train_minimal.py \
  ...
  --exp-name activemq_codediffpro_fromscratch_ep20_eval1_20260408 \
  --batch-size 8 \
  --num-epochs 100 \
  --eval-every 1 \
  --save-every 1 \
  ...
  --resume-checkpoint /mnt/sda/wanght19/code/SVD/DiffuModel/SeqDiffuSeq/codediffpro/output/model/activemq/activemq_codediffpro_fromscratch_ep20_eval1_20260408/checkpoint_20epochs.pth
